...
public abstract class UUDatabaseV2 implements UUDatabaseDefinition
{
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // Private Variables
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    protected UUDatabaseV2(@NonNull final Context context)
    {
            ...
            @NonNull final ContentValues cv)
    {
        ...
        try
        {
            ...
            if (rowid == -1)
            {
                UULog.warn(UUDatabaseV2.class, "insert", "DB insert returned -1, this indicates an error!");
            }
        }
        catch (Exception ex)
        {
            ...
            @NonNull final ContentValues cv)
    {
        ...
        try
        {
            ...
            if (rowid == -1)
            {
                UULog.warn(UUDatabaseV2.class, "replace", "DB replace returned -1, this indicates an error!");
            }
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            while (c.moveToNext())
            {
                ...
                if (first)
                {
                    ...
                    UULog.debug(UUDatabaseV2.class, "logQueryResults", sb.toString());
                }
    ...
    public void safeEndTransaction(@Nullable final UUSQLiteDatabase db)
    {
        ...
        {
            UULog.error(UUDatabaseV2.class,"safeEndTransaction", ex);
        }
    }
